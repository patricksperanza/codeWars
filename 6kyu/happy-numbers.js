...
// Pseudo-code
// create an array
// While n does not equal 1 and while n is at the last index of the array
// push n to the the array
// n ---- convert to string and split. Map each digit and square it. Reduce the sum of the squared digits.
